function reverseString(str) {
  ...
  function checkDateFormats(date){
    var listOfPalindromes = getDateFormats(date);
  ...
  function getNextPalindrome(date){
    ...
    while(1){
      ctr++;
      var isPalindrome = checkDateFormats(nextDate);
      if(isPalindrome){
        break;
      }
  ...
  function clickHandler(e){
    ...
    if(bdayStr !== ''){
      ...
      var isPalindrome = checkDateFormats(date);
  
      if(isPalindrome){
         resultRef.innerText = 'Yoo, your birthday is a palindrome!';
      }
      else {
